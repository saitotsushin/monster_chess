...
// export function checkitem(chess,tilePropMap,pos,scene){

//   let item = tilePropMap[pos.Y][pos.X].item;
...
//     item.damage(chess,pos);

//     tilePropMap[pos.Y][pos.X].item = "";

//     itemObject = scene.item.itemGroup.children.entries[item.groupIndex];
//     itemObject.destroy();
//   }
